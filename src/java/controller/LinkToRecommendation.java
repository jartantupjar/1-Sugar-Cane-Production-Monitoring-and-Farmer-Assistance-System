 ...
 */
public class LinkToRecommendation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            java.sql.Date rdate = Date.valueOf(lined);
            
                java.util.Date date;
            try {
                date = new SimpleDateFormat("MM/dd/yyyy").parse(lined);
                rdate = new java.sql.Date(date.getTime());
            } catch (ParseException ex) {
                Logger.getLogger(LinkToRecommendation.class.getName()).log(Level.SEVERE, null, ex);
            }
